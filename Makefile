...
GPU_CFLAGS ?= -O3 -ffast-math -fno-approx-func -fno-finite-math-only -pthread -Wno-unused-command-line-argument --offload-arch=$(ROCM_ARCH)
...
ifeq ($(UNAME_S),Darwin)
	...
	$(GPU_CC) $(GPU_CFLAGS) -o $@ ds4_test.o ds4_help.o ds4_kvstore.o rax.o $(CORE_OBJS) $(GPU_LDLIBS)
endif
